		...
		<div className='py-16 flex flex-col items-center lg:py-20 px-2'>
			<div className='max-w-xl mb-10 md:mx-auto sm:text-center md:mb-12'>
				...
				<p className='text-base text-gray-700 md:text-lg'>
					Discover the unique advantages of Bild3r, a Web3-based real estate
					development trust.
				</p>
			</div>
				...
				<div className='space-y-6 sm:px-2'>
					...
					<div className='flex flex-col sm:flex-row show'>
						...
						<div>
							...
							<p className='text-sm text-gray-900'>
								Blockchain technology ensures clear, real-time tracking of fund
					...
					<div className='flex flex-col sm:flex-row show'>
						...
						<div>
							...
							<p className='text-sm text-gray-900'>
								Leverages smart contracts for efficient and accurate
				...
				<div className='space-y-6 sm:px-2'>
					...
					<div className='flex flex-col sm:flex-row show'>
						...
						<div>
							...
							<p className='text-sm text-gray-900'>
								Blockchain infrastructure provides robust protection against
